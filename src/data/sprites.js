...
export const SPRITE_TYPES = [
  ...
  { id: 'fishy', name: 'Fishy', icon: '🐟', rarity: 'Rare', dropRate: null, released: true,
    ...
    variants: { normal: R } },
  { id: 'aura', name: 'Aura', icon: '✨', rarity: 'Rare', dropRate: null, released: true,
    ability: 'Emits a healing aura for you and teammates.',
    variants: { normal: R } },
  { id: 'boss', name: 'Boss', icon: '🤵', rarity: 'Rare', dropRate: null, released: true,
    ability: 'Hires AI henchmen to fight alongside you.',
    variants: { normal: R } },
  { id: 'grim', name: 'Grim Reaper', icon: '💀', rarity: 'Rare', dropRate: null, released: true,
    ability: 'Marks eliminated enemies to harvest bonus souls/XP.',
    variants: { normal: R, galaxy: R } },
