...
export const SPRITE_TYPES = [
  ...
  { id: 'birthday', name: 'Birthday', icon: '🎂', rarity: 'Rare', dropRate: null, released: false, rumored: true, gen: 'c7s4',
    ability: 'A Rare Sprite for Fortnite’s 9th Birthday. Opening chests has a chance to spawn a piece of cake (and at max level, eliminations can too); eating the cake restores both Health and Shield, and the spawn chance rises with each level up. Reported for Sat Sep 26 with a Birthday Power Hour. Files added in the v42.20 update (Sep 17) with Normal, Gold, Cheat Master, Loot Hacker and Bounty Hunter finishes. (Datamine / reported details: Vice.)',
