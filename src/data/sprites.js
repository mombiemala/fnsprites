...
export const SPRITE_TYPES = [
  ...
  { id: 'pond', name: 'Pond', icon: '🐸', rarity: 'Epic', dropRate: null, released: false, rumored: true, gen: 'c7s4',
    ...
    variants: { normal: U } },
  { id: 'onigiri', name: 'Onigiri', icon: '🍙', rarity: 'Epic', dropRate: null, released: false, rumored: true, gen: 'c7s4',
    ability: 'Design-a-Sprite winner (by Enorull) — Epic swapped Enorull’s original “Bullet” concept for their Onigiri Sprite. Ability not yet detailed; rarity TBC. Arrives Sep 3 (New Sprite Day) as one of the first two winners, alongside X-Ray.',
    variants: { normal: U } },
