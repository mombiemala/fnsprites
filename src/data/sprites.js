...
export const SPRITE_TYPES = [
  ...
  { id: 'overshield', name: 'Overshield', icon: '🛡️', rarity: 'Epic', dropRate: null, released: true, gen: 'c7s4',
    ability: 'Chapter 7 Season 4 “Override” Sprite — Overshield. Live in all three current finishes (Normal · Gold · Cheatmaster); the Loot Hacker finish is datamined but not yet released. Exact in-game ability not fully documented here yet.',
    variants: { normal: R, gold: R, cheatmaster: R, loothacker: U } },
