...
export const NEWS = [
  ...
  },
  {
    ...
    title: '⚡ Power Hours Saturday — Gold & Cheat Master Sprites boosted (Sep 12)',
    body: 'Power Hours return Saturday, Sep 12 in two windows — 2–4 PM & 9–11 PM ET — with boosted spawns for Gold and Cheat Master Sprites plus supercharged Overdrive Grenades, a strong window to fill in premium finishes. Two new variants are also being added to the island: the Cheat Master Storm Scout and Gold Onigiri Sprites. 1-Up Tokens and Portable Extractors can drop from Chests.',
  ...
  },
  {
    ...
    when: 'Sep 10, 2026',
    tag: 'sprites',
    title: '🔵 New Sprites Day — Loot Hacker finishes are LIVE (Sep 10)',
    body: 'Live now: the Sep 10 update added the Loot Hacker finish to the loot pool — 14 new Loot Hacker Sprite variants (15 incl. the already-out Crown), spanning Klombo, Jackrabbit, Killswitch, Tails, Sonic, Shadow, 8-Bit, Bush Ranger, Adventure, Jonesy, Storm Scout, X-Ray, Onigiri and Overshield. Each keeps its base Sprite’s ability and adds a +20% (1.2×) chance of Loot Hack items from Chests. All 15 are now marked released in the tracker.',
    link: 'https://x.com/Fortnite/status/2096659818052468944',
  ...
  },
  {
    ...
    title: '⭐ Mastery Monday today — 2× Sprite XP & Dust (Mon, Sep 7)',
    body: 'Mastery Monday runs today from 9 AM ET (Mon, Sep 7) for 24 hours, ending 9 AM ET Tuesday — double Sprite XP and double Sprite Dust, the fastest window to level Sprites toward Mastery. Epic also tied it to an upcoming Sprite Back Bling: Sprites you Master now will auto-unlock in that cosmetic when it ships. A fresh Admin Panel code dropped alongside it — check the Lobby Hacks page.',
    link: 'https://x.com/Fortnite/status/2096659818052468944',
    source: 'Epic (Fortnite / X)',
    official: true,
  },
  ...
  },
  {
    ...
    title: '🏆 Sprites now work in Ranked (abilities disabled)',
    body: 'With the v42.10 update, Sprites now appear in Ranked too — but with their abilities disabled to keep competition even. You can still collect, equip and show them off in Ranked; they just don’t grant their gameplay power there. Straight from Epic’s in-game news.',
    link: 'https://www.fortnite.com/news',
    source: 'Epic (in-game news)',
    official: true,
  },
  {
    ts: '2026-09-03',
    ...
    title: '🍙 New Sprite Day — X-Ray & Onigiri are live',
    sprites: ['xray', 'onigiri'],
    body: 'The first two Design-a-Sprite contest winners went live at today’s New Sprite Day reset (~9 AM ET) in the v42.10 update, so we’ve flipped both to released: X-Ray (by Avila215 — reveals nearby players and objects through walls, like the old medallion) and Onigiri (by Enorull, who swapped their original “Bullet” concept for it). Normal finish is out now; other finishes may roll out later. The same update also brought Overshield and the Mega Man collab Sprite live. The remaining three Design-a-Sprite winners (Pond, Honey, Dumpster Dive) follow later this season.',
  ...
  },
  {
    ...
    title: '⚡ Power Hours today — Cheat Master Sprites boosted (Sat, Sep 5)',
    body: 'Cheat Master Sprite Power Hours run today (Sat, Sep 5) in two windows — 2–4 PM & 9–11 PM ET. Cheat Master Sprites spawn far more often, so it’s the best window to grab the ones you’re missing — including the rare Cheat Master Klombo. 1-UP Tokens and Portable Extractors turn up in Chests as bonus finds, and you drop in with some starter items (Golden Apple, Jellyfish, Peppers). Boosted spawns end when the week resets.',
  ...
  },
  {
    ...
    title: '⭐ Cheat Code Day — 2× Sprite Dust & XP today',
    body: 'Epic kicked the week off with Cheat Code Day (Mon, Aug 31) — 2× Sprite Dust and 2× Sprite Level (XP) for 24 hours. Still ahead this week: Update Day on Thursday (Sep 3) brings new Sprites (X-Ray + Onigiri), new gizmos/loading screens and a weapon loot-pool refresh, and Power Hours on Saturday (Sep 5) with 1-UP Tokens, boosted Sprite spawns and Portable Extractors.',
    link: 'https://www.instagram.com/fortnite/',
    source: 'Epic (Fortnite Instagram)',
    official: true,
  },
