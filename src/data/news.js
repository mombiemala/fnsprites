...
export const NEWS = [
  {
    ...
    sprites: ['peely'],
    body: 'Epic has confirmed the Sprite system is permanent — “Sprites are staying forever: all generations, always yours.” Every past and future Sprite stays in your collection, a new generation arrives each season, past generations are never removed, and your collection lives on even after Battle Royale. Epic also teased new features: a Sprite Garden to showcase your full collection on a private island, and the ability to visit friends’ Sprite Gardens together. (This settles the earlier “won’t carry over” rumor — your collection is safe.)',
  ...
  },
  {
    ...
    body: 'Season "Runners" is scheduled to end Aug 19, 2026 — wrap up your Battle Pass before it rotates. Good news for collectors: your Sprites are safe. Epic has confirmed Sprites stay forever — every past and future generation stays in your collection across seasons — so nothing you’ve earned is lost when the season ends. (If you’re still chasing the free Quack Zero Point, it unlocks at 55 mastered Sprites.)',
    link: 'https://www.fortnite.com/news',
    source: 'Epic Games',
    official: true,
  },
  {
    ...
    tag: 'upcoming',
    tentative: true,
    title: 'Next season leak: “Gaming Legends” — Sonic, Mega Man, Persona & more',
    body: 'Leaks (ShiinaBR & HYPEX, from datamined v41.30 files) point to Chapter 7 Season 4 themed “Gaming Legends,” with a gaming-crossover roster — Sonic & Dr. Eggman, Mega Man, Persona 5’s Joker, Pac-Man, Tetris, Crash Bandicoot and Kingdom Hearts (Sora). Start date is unsettled: internal files first showed Sept 4, but newer datamines point to Aug 19–20, right as S3 ends. A Pac-Man easter egg is already looping at the Wonkeeland POI. For collectors: Epic has confirmed Sprites stay forever, with a new generation each season — so your current collection carries into Gaming Legends and beyond. Epic hasn’t confirmed the roster or start date, though.',
