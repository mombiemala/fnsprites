...
export const NEWS = [
  ...
  },
  {
    ...
    when: 'Jul 29, 2026',
    tag: 'upcoming',
    title: 'Leak: July 30 is really 10 new Sprites — 3 base + 7 Gem variants 💎',
    body: 'Epic promoted three new Sprites for July 30 (Peely, Loot Llama, Quack Zero Point), but datamined banner art points to seven Gem variants landing the same day too — Gem forms for Water, Earth, Duck, Demon, Aura and Zero Point, plus the exclusive Quack Zero Point — which is where the “10 new Sprites” figure comes from. All part of the one v41.30 drop; unconfirmed until Epic’s patch notes.',
  ...
  },
  {
    ...
    link: 'https://chainplay.gg/blog/fortnite-john-wick-sprite-release-date-powers-and-reload-mode-details/',
    source: 'ChainPlay',
    official: false,
    tentative: true,
  },
