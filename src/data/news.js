...
export const NEWS = [
  ...
  },
  {
    ...
    body: 'Power Hours return Saturday, Sep 12 with boosted spawns for Gold and Cheat Master Sprites, plus supercharged Overdrive Grenades — a strong window to fill in premium finishes. Follows the usual Power Hours windows.',
  ...
  },
  {
    ...
    title: '🔵 New Sprites Day — Loot Hacker finishes go live (Thu, Sep 10)',
    body: 'On Thursday, Sep 10 (~9 AM ET) the datamined Loot Hacker finish enters the loot pool: 14 new Loot Hacker Sprite variants unlock (15 incl. the already-out Crown) — spanning Klombo, Jackrabbit, Killswitch, Tails, Sonic, Shadow, 8-Bit, Bush Ranger, Adventure, Jonesy, Storm Scout, X-Ray, Onigiri and Overshield. Each keeps its base Sprite’s ability and adds roughly +20% odds of Loot Hack items in chests. We’ll flip them to released here the moment they’re live.',
    link: 'https://x.com/Fortnite/status/2096659818052468944',
    source: 'Epic (Fortnite / X)',
    official: true,
  },
