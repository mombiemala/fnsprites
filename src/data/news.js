...
export const NEWS = [
  ...
  {
    ts: '2026-07-09',
    when: 'Jul 9, 2026 (expected)',
    tag: 'upcoming',
    tentative: true,
    title: 'Holofoil Sprites — a Holofoil variant for every Sprite',
    body: 'Holofoil is set to arrive July 9 as a new variant of each existing Sprite, with an iridescent foil finish. Reported perk: +5% squad chance to find rare Sprites. Community-dated — not yet confirmed by Epic, so treat as tentative.',
    link: 'https://www.hotspawn.com/fortnite/news/fortnite-holofoil-sprites',
    source: 'Hotspawn',
    official: false,
  },
  {
