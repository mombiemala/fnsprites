...
export const NEWS = [
  ...
  },
  {
    ...
    sprites: ['zeropoint'],
    body: 'The final stretch of Season 3 is stacked. Aug 15: the “Unstable” Story Moment (2 PM ET) + Mythic Sprite Hours that evening. Then “Sprite Spree Week” starts Sunday, Aug 16 — a different finish appears far more often for a full 24 hours each day: Galaxy (Aug 16), Holofoil (Aug 17), Cube (Aug 18), Gem (Aug 19). Bonuses run all week: Sprite XP is 2× by default (4× if you stop by a campfire); extra Lucky Locators are guaranteed to point you at a Sprite you don’t own yet; Bonus Quests hand out a free Gem Zero Point Sprite; and — confirmed by Epic (Alec Shobin) — from Aug 16 you can re-summon any Sprite you lose in a match for free (no Sprite Dust) until the season ends. Then Chapter 7 Season 4 “Override” launches Thursday, Aug 20 (~4 AM ET). The best week of the season to finish your Galaxy / Holofoil / Cube / Gem lines.',
    link: 'https://beebom.com/fortnite-sprite-events-schedule/',
