...
export const NEWS = [
  ...
  },
  {
    ...
    when: 'Jul 30, 2026',
    tag: 'sprites',
    title: 'Zero Point finishes: Cube is obtainable, Holofoil still staged 🔷',
    sprites: ['zeropoint'],
    body: 'v41.30 added two more Zero Point Sprite finishes. Cube Zero Point is obtainable — it’s been live since v41.30 (Jul 30), hiding in Vault / keycard Sprite Chests at an extremely low rate (Space-Chest odds under ~0.01%), so it’s now marked Available in the tracker. Holofoil Zero Point, added to the files in the same patch, is still not obtainable and stays flagged “Soon” until Epic switches it on — likely a later New Sprite Day. Zero Point remains the game’s rarest base Sprite (Mythic, ~0.00034%).',
    link: 'https://fortnite.gg/sprites/112-cube-zero-point-sprite',
    source: 'Fortnite.GG',
    official: false,
  },
  {
