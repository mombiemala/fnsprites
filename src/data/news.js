...
export const NEWS = [
  {
    ...
    body: 'Straight from Epic: today is Cheat Code Day — 2× Sprite Dust and 2× Sprite Level (XP) for 24 hours. It’s the best day of the week to level and master Sprites and to bank Dust for summons and Loot Hacks. Epic also revealed the rest of the week: Update Day on Thursday (Sep 3) brings new Sprites, new gizmos/loading screens and a weapon loot-pool refresh, and Power Hours on Saturday (Sep 5) with 1-UP Tokens, boosted Sprite spawns and Portable Extractors.',
