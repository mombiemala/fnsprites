...
export const NEWS = [
  ...
  },
  {
    ...
    when: 'Aug 19, 2026',
    tag: 'upcoming',
    title: 'Chapter 7 Season 3 ends — claim free Sprites before Aug 19',
    body: 'Season "Runners" is scheduled to end Aug 19, 2026 — last call to finish your collection and Battle Pass. Collectors, note two deadlines: the free Quack Zero Point Sprite (unlocked at 55 mastered Sprites) is only claimable until the season ends, and reports say your Chapter 7 Season 3 Sprite collection won’t carry into Season 4 — so master what you want and grab any free rewards before Aug 19. (Season-end date per Epic; the no-carry-over detail is a leak.)',
  ...
  },
  {
    ...
    body: 'Leaks (ShiinaBR & HYPEX, from datamined v41.30 files) point to Chapter 7 Season 4 themed “Gaming Legends,” with a gaming-crossover roster — Sonic & Dr. Eggman, Mega Man, Persona 5’s Joker, Pac-Man, Tetris, Crash Bandicoot and Kingdom Hearts (Sora). Start date is unsettled: internal files first showed Sept 4, but newer datamines point to Aug 19–20, right as S3 ends. A Pac-Man easter egg is already looping at the Wonkeeland POI. For collectors: the Sprite system looks set to continue (Mastery Mondays are scheduled into mid-September), but reports say your Season 3 Sprite collection won’t carry over — so wrap it up before Aug 19. Epic hasn’t confirmed any of this.',
