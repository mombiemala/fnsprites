...
export const NEWS = [
  {
    ...
    sprites: ['peely'],
    body: 'Epic has confirmed the Sprite system is permanent — every past Sprite stays in your collection, and a full new generation arrives with each season. Chapter 7 Season 4 (“Override”) brings that new generation with new powers, new variants, quality-of-life improvements and new ways to find Sprites. The headline is the Sprite Garden: a separate island getaway (a UEFN experience built with Fairview Portals & Beyond Creative) where you play with, showcase and organise your whole collection and visit friends’ gardens. Your Season 3 Sprites are preserved there automatically, every new Override Sprite is auto-added, and a Sprite that goes down in a match is never erased from your garden. S3 Sprites also stay on your Collection page (and surface as Sprite Mastery Pod Back Bling styles + Guardian Outfit pilots). The Garden will keep growing with player feedback, and older generations may return later. This settles the earlier “won’t carry over” rumor — your collection is safe.',
  ...
  },
  {
    ...
    body: 'Epic has confirmed Chapter 7 Season 4 — titled “Override,” tagline “Break the rules, change the game” — launches Thursday, Aug 20, 2026 (leaks peg the go-live around 4 AM ET, after the v42.00 downtime), bringing a full new generation of Sprites. Sonic the Hedgehog headlines a “Gaming Legends” theme (a Green Hill Zone POI is rumored); the rest of the lineup is still leak-only — ShiinaBR & HYPEX, from datamined files, list Dr. Eggman, Mega Man, Persona 5’s Joker, Pac-Man, Tetris, Crash Bandicoot, Kingdom Hearts (Sora) and Vampire Survivors — with a Pac-Man easter egg already looping at the Wonkeeland POI. Whether each collab gets its own themed Sprite isn’t confirmed yet. Your Season 3 Sprites carry over (Epic confirmed Sprites stay forever), so the new generation joins your existing collection rather than replacing it.',
