...
export const NEWS = [
  ...
  },
  {
    ...
    title: 'New Sprite Day is LIVE (v41.30): 20 new Sprites — the count hits 111 🍌',
    sprites: ['zeropoint'],
    body: 'v41.30 is live with 20 new Sprites (roster now 111) — five bring new powers: Peeky Peely emits a ping revealing players with rare Sprites nearby (but marks you); Lootin’ Llama gives a chance to upgrade weapons from ammo boxes; the Ironmouse VTuber collab regenerates health while granting Cloak and low gravity when you drop low; John Wick reveals nearby enemies after a knock or elimination (exclusive to Springfield Reloaded); and Spider-Man joins via the Brand New Day collab. New variants: full Gold/Gummy/Galaxy/Gem/Holofoil lines for Peely & Llama, Grim’s Gem + Holofoil, and Quack variants for Water, Earth, Fire & Zero Point. It’s the last major Chapter 7 Season 3 drop. Rarities and drop rates are community estimates until Epic publishes official figures.',
  ...
  },
  {
    ...
    title: 'Web-Shooter Power Hour — Spider-Man: Brand New Day 🕷️',
    body: 'A special Web-Shooter Power Hour runs Friday, August 1, tied to the Spider-Man: Brand New Day collab and the new Spider-Man Sprite (leaked web-swinging “Sprite Net” traversal). Expect boosted spawns during the window — check in-game timing on the day.',
