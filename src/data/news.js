...
export const NEWS = [
  {
    ...
    body: 'The v41.30 update lands Thursday, July 30 (4 AM PT / 7 AM ET), with three new Sprites expected once the weekly reset runs (~9 AM ET): Peely, Loot Llama, and the ultra-rare Quack Zero Point. Datamined abilities: Peely reportedly gives a chance to upgrade weapons pulled from ammo boxes, while Quack Zero Point spawns a Shield Bubble Jr. when you use a healing item on yourself — and Zero Point is said to be the only Sprite carrying the exclusive Quack variant, making it especially hard to complete. Peely and Llama are expected to bring their own Gold/Gummy/Galaxy/Holofoil variants, and new Gem variants are said to arrive in the same update. It’s the last major Chapter 7 Season 3 drop, arriving alongside the Spider-Man collab (leaked web-swinging “Sprite Net”), with boosted new-Sprite spawns during Power Hours (2 & 9 PM ET). Abilities, rarities and variants are all datamined and not yet confirmed — treat as leaks until Epic’s patch notes.',
  ...
  },
  {
    ...
    when: 'Jul 29, 2026',
    tag: 'upcoming',
    title: 'Leak: up to 10 more Sprites datamined for after New Sprite Day 🔎',
    body: 'Dataminers have surfaced references to as many as 10 additional Sprites lined up to roll out after the July 30 New Sprite Day — a sign Chapter 7 Season 3 keeps expanding the roster through the rest of the season. Names, abilities and dates are unconfirmed; treat as datamined leaks until Epic announces them.',
  ...
  },
  {
    ...
    when: 'Jul 29, 2026',
    tag: 'upcoming',
    title: 'John Wick Sprite revealed — powers & how to get it 🎯',
    body: 'A John Wick Sprite has been revealed for an upcoming collab, with datamined powers and a release window circulating ahead of Epic’s confirmation. It joins the other datamined collab Sprites still awaiting official reveals (Spider-Man, plus the leaked Drifter and Ice). Details are unconfirmed — treat as a leak until it’s in the game.',
    link: 'https://www.vice.com/en/article/fortnite-john-wick-sprite-release-date-powers-how-to-get/',
    source: 'Vice',
    official: false,
    tentative: true,
  },
