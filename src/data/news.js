...
export const NEWS = [
  ...
  },
  {
    ...
    title: 'Sprite Spree Week — a themed Sprite Hour every day 💫',
    sprites: ['zeropoint'],
    body: 'Season 3 goes out with a “Sprite Spree Week” — a Sprite Power Hour every day, each boosting a different finish so you can complete that set before the season ends. Schedule: Aug 15 — “Unstable” Story Moment (2 PM ET) + Mythic Sprite Hours (evening); Aug 16 — Galaxy Sprite Hours (all day); Aug 17 — Holofoil Sprite Hours (all day); Aug 18 — Cube Sprite Hours (all day); Aug 19 — Gem Sprite Hours (all day). Then Chapter 7 Season 4 “Override” launches Thursday, Aug 20 at ~4 AM ET (downtime). Perfect week to finish your Galaxy / Holofoil / Cube / Gem lines and hunt the Mythic rarities. Community-sourced schedule; times/details may shift.',
    link: 'https://beebom.com/fortnite-sprite-events-schedule/',
    source: 'Community schedule',
    official: false,
  },
  {
    ts: '2026-08-15',
