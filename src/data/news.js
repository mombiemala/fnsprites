...
export const NEWS = [
  {
    ...
    title: 'New Sprite Day is LIVE (v41.30): Peely, Loot Llama & Quack Zero Point 🍌',
    body: 'The v41.30 update is live — three new Sprites join the hunt: Peely (chance to upgrade weapons pulled from ammo boxes), Loot Llama (pings nearby rare Sprites), and the ultra-rare Quack Zero Point, the exclusive Quack variant of Zero Point (spawns a Shield Bubble Jr. when you heal yourself). A Gem wave lands too — Gem variants for Water, Earth, Duck, Demon, Aura and Zero Point. It’s the last major Chapter 7 Season 3 drop, alongside the Spider-Man: Brand New Day collab and John Wick over on Springfield Reloaded. Rarities and drop rates are still community estimates until Epic publishes official figures.',
  ...
  },
  {
    ...
    when: 'Jul 30, 2026',
    tag: 'sprites',
    title: 'The Gem wave: 7 new Gem variants live with v41.30 💎',
    body: 'Beyond the three headline Sprites, v41.30 adds seven new variant forms — Gem versions of Water, Earth, Duck, Demon, Aura and Zero Point, plus the exclusive Quack Zero Point — which is where the “10 new Sprites” figure comes from. Mark them off as you extract them.',
    link: 'https://www.vice.com/en/article/10-new-fortnite-sprites-july-30/',
    source: 'Vice',
    official: false,
  },
  {
