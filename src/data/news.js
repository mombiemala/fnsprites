...
export const NEWS = [
  ...
  {
    ts: '2026-08-04',
    when: 'Reported Aug 4, 2026',
    tag: 'bug',
    tentative: true,
    start: '2026-08-04',
    end: '2026-08-08',
    title: 'Reported: Ironmouse Sprite not extracting since its return',
    sprites: ['ironmouse'],
    body: 'Some players report the Ironmouse Sprite isn’t extracting since its Aug 4 return — it either doesn’t appear or can’t be extracted. Unconfirmed: we haven’t found an official Epic acknowledgement yet, and part of it may be timing — the return went live Aug 4 at 6 PM PT / 9 PM ET with boosted rates only until Aug 5, 3 AM ET, and it’s very rare after that. Monitoring; we’ll update as soon as Epic or a reliable leaker confirms a cause or fix.',
