...
export const NEWS = [
  ...
  },
  {
    ...
    tag: 'upcoming',
    tentative: true,
    title: 'Next season: Ch 7 S4 “Override” (Aug 19) — “Gaming Legends” collabs leaked',
    body: 'Chapter 7 Season 4 begins Aug 19–20, 2026 — right as Runners ends — and Epic has confirmed a new generation of Sprites arrives with it (the season is titled “Override”). The collab lineup is still leak-only: ShiinaBR & HYPEX, from datamined v41.30 files, point to a “Gaming Legends” theme — Sonic & Dr. Eggman, Mega Man, Persona 5’s Joker, Pac-Man, Tetris, Crash Bandicoot and Kingdom Hearts (Sora) — and a Pac-Man easter egg is already looping at the Wonkeeland POI. Your Season 3 Sprites carry over (Epic confirmed Sprites stay forever), so the new generation joins your existing collection rather than replacing it.',
  ...
  },
  {
    ...
    body: 'Epic has revealed the winners of its “Design-a-Sprite” contest (20,000+ entries): five fan-made Sprites will be built into the game — Pond (Pine & Kiri), Bullet (Enorull), Honey (Conejito_sam), Dumpster Dive (a raccoon, by StinkyPrincessGoose) and X-Ray (Avila215). They won’t arrive this season — Epic says they land in a mid-season update during Chapter 7 Season 4 “Override.” They’ll be added to the tracker once they’re in-game.',
