...
export const NEWS = [
  ...
  {
    ts: '2026-07-23',
    when: 'Late Jul 2026 (leaked)',
    tag: 'upcoming',
    tentative: true,
    title: 'Cube Sprite variant — a new special finish (teased)',
    body: 'Epic has teased a new Cube Sprite variant, and datamined marketing points to it going live in late July — likely around July 23–30 with v41.30. It would join Gold, Gummy, Galaxy & Holofoil as another special finish across the roster (the tracker already lists Cube as a Rumored form on each sprite). Exact date leaked/unconfirmed — treat as tentative until Epic announces it.',
