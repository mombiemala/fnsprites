...
export const NEWS = [
  ...
  },
  {
    ...
    tag: 'upcoming',
    tentative: true,
    title: 'Ch 7 S4 “Override” (Aug 20) — the leaked new-generation Sprite roster',
    body: 'Override — tagline “Break the rules, change the game” — launches Thursday, Aug 20 (v42.00, ~2 AM ET downtime, servers back ~6 AM ET) with a “Gaming Legends” theme and a full new generation of Sprites. Sonic headlines and is trailer-confirmed (leaked ability: a Spin Dash / sprint-speed boost). The rest of the Sprite lineup is datamine-only (HYPEX, ShiinaBR, @FN_Assist): Tails (glide/hover), Jazz Jackrabbit (air double-jump), Klombo, Bushranger, Killswitch, Victory Crown and The Adventurer — roughly 8 new Sprites at launch, with abilities and rarities mostly unconfirmed. Plenty of collab skins are in the trailer (Mega Man, Pac-Man, Crash Bandicoot, Spyro, Mortal Kombat, Persona 5’s Joker, Tetris) but it’s not confirmed each gets its own Sprite; Kingdom Hearts and Vampire Survivors were leaked but not shown in the trailer (lower confidence). A Sprite redesign is also leaked — Sonic appears as a blocky “cube backpack” strapped to the player rather than the hovering companion, matching the season’s pixel look. Your Season 3 Sprites are preserved in the Sprite Garden and your Collection, but a new generation takes over Battle Royale — old-gen Sprites aren’t used in BR matches at launch.',
