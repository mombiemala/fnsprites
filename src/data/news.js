...
export const NEWS = [
  {
    ...
    body: 'The first two Design-a-Sprite contest winners went live at today’s New Sprite Day reset (~9 AM ET) in the v41.10 update, so we’ve flipped both to released: X-Ray (by Avila215 — reveals nearby players and objects through walls, like the old medallion) and Onigiri (by Enorull, who swapped their original “Bullet” concept for it). Normal finish is out now; other finishes may roll out later. Reports also mention a third, still-unnamed “Knight” Sprite in the same update — we’ll add it once Epic details its name and power. The remaining three Design-a-Sprite winners (Pond, Honey, Dumpster Dive) follow later this season.',
